...
void deviceFallback() {
  ...
  if (safePin == HIGH && triggerPin == HIGH) {
    ...
    terminal.print(F("clearing wifi settings and resetting device in  "));
...
void setup() {
  ...
  timer.setInterval(10000L, myDeviceStats);  // get stats every 10 seconds. Fine for basic knowledge
}
